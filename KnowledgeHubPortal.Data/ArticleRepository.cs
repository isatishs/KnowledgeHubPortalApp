...
namespace KnowledgeHubPortal.Data
{
    public class ArticleRepository : IArticleRepository
    {
        ...
        public List<Article> GetAllArticlesForApprove(int categoryId = 0)
        {
            ...
            //if (categoryId == 0)
            //{
            //    return db.Articles.Where(a=>a.IsApproved==false).ToList();
            //}
            //else
            //{
            //    var articles = db.Articles.Where(a => a.IsApproved == false && a.CategoryId == categoryId );
        ...
        public List<Article> GetAllArticlesForBrowse(int categoryId = 0)
        {
            ...
            //if (categoryId == 0)
            //{
            //    return db.Articles.Where(a => a.IsApproved == true).ToList();
            //}
            //else
            //{
            //    var articles = db.Articles.Where(a => a.IsApproved == true && a.CategoryId == categoryId);
